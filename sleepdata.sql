...
--
-- Host: 127.0.0.1
-- Creato il: Apr 18, 2025 alle 15:30
...
--
-- Struttura della tabella `sleepdata`
--
...
CREATE TABLE `sleepdata` (
  ...
  `QualitySleep` int(11) DEFAULT NULL,
  `PhysicalActivity Level` int(11) DEFAULT NULL,
  `StressLevel` int(11) DEFAULT NULL,
  `BMICategory` varchar(255) DEFAULT NULL,
  `BloodPressure` varchar(255) DEFAULT NULL,
  `HeartRate` int(11) DEFAULT NULL,
  `DailySteps` int(11) DEFAULT NULL,
  `SleepDisorder` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dump dei dati per la tabella `sleepdata`
--

INSERT INTO `sleepdata` (`PersonID`, `Gender`, `Age`, `Occupation`, `SleepDuration`, `QualitySleep`, `PhysicalActivity Level`, `StressLevel`, `BMICategory`, `BloodPressure`, `HeartRate`, `DailySteps`, `SleepDisorder`) VALUES
